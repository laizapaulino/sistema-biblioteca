            ...
            <div class="card-body">
              ...
              <ul class ="list-group list-group-flush">
                    ...
                    <div class="form-group row">
                      <div class="col-md-11" >
                      <form action="../public/db-connect/trabalho/atualiza-trabalho.php?<?=$trabalho['codigo']?>" method="post">
                          

                            <label class="text-primary" for="ISBN">Código:</label> <?=$trabalho['codigo']?><br>
                            <label class="text-primary" for="nome_autor">Autor 1:</label>
                            <input class="form-control" type="text" value="<?=$trabalho['autor_1']?>" name="autor_1" placeholder="Se não  houver, não preencha" required>
                            <label class="text-primary" for="nome_autor">Autor 2:</label>
                            <input class="form-control" type="text" value="<?=$trabalho['autor_2']?>" name="autor_2" placeholder="Se não  houver, não preencha" >
                            <label class="text-primary" for="nome_autor">Autor 3:</label>
                            <input class="form-control" type="text" value="<?=$trabalho['autor_3']?>" name="autor_3" placeholder="Se não  houver, não preencha" >
                            <label class="text-primary" for="nome">Nome:</label>
                            <input class="form-control" type="text" value="<?=$trabalho['nome']?>" name="nome" required>
